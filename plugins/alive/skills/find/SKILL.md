---
name: find
description: "Use when you asks where something is, who someone is, what was decided, or anything that requires retrieving past context — searches decisions, people, files, references, insights, and log history across all walnuts in priority order."
user-invocable: true
---
