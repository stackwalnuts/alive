...
Not a search (that's find — searches content across walnuts). History searches SESSIONS — what squirrels did, what was discussed, what was decided. For deep context extraction from source material, use `walnut:mine-for-context`.
...
When history finds sessions with rich, unmined context — long sessions, many stash items, transcripts with extensive research or decision-making — suggest escalation to `walnut:mine-for-context`:
...
│
│  → Mine them (walnut:mine-for-context)
...
- Not `walnut:search-world` — search-world searches content across walnuts. History searches sessions.
- Not `walnut:system-cleanup` — system-cleanup surfaces broken things. History surfaces past context.
- Not `walnut:mine-for-context` — mine-for-context does deep extraction from source material. History is the lighter "what happened recently?"
