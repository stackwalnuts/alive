...
This skill is invoked by the capsule awareness injection, by the load skill's "what are you working on?" prompt, or directly by the human via `/walnut:capsule-manager`.
