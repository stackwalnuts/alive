...
/walnut:load-context           load a walnut (prev. open)
/walnut:save                   checkpoint — route stash, update state
/walnut:capture-context        context in — store, route
/walnut:capsule-manager        create, share, graduate capsules
/walnut:search-world           search across walnuts
/walnut:create-walnut          scaffold a new walnut
/walnut:system-cleanup         system maintenance
/walnut:settings               customize preferences, voice, rhythm
/walnut:session-history        squirrel activity, session timeline
/walnut:mine-for-context       deep context extraction
/walnut:build-extensions        create skills, rules, hooks for your world
/walnut:my-context-graph       render the world graph
/walnut:session-context-rebuild  rebuild context from past sessions
/walnut:migrate-alive-to-v1    migrate from alive to walnut
```
