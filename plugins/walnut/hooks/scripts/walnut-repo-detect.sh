...
REPO_MSG="Repo context detected: CWD matches walnut [[${REPO_WALNUT}]] (dev.local_path: ${REPO_PATH}). Consider loading this walnut's context with /walnut:load-context ${REPO_WALNUT}."
